...
<img src="./img/login-robot.png" alt="캡챠 예시"></img><br/>  
4. 로그인이 성공했다면 __HOME 버튼을 눌러주시고__, 조금만 기다려주시면 자동으로 창이 꺼지면서 로그인이 성공됩니다.    
<img src="./img/login-404.png" alt="로그인 성공 예시"></img><br/>  
5. 잠시 후 알림이 시작 됩니다.  
...
1.10.1  
-자동 빌드, 업로드 시스템(github workflow)을 적용했습니다. (기능과 무관)
